...
def test_json_to_demol_basic():
    ...
    json_data = {
        ...
        "peripherals": [
            {"name": "LedGeneric", "instanceName": "Led1"}
        ],
        "connections": [
            {
                "fromName": "Led1",
            ...
            },
            {
                ...
                "type": "power",
                "mappings": [
                    {"fromPin": "gnd", "toPin": "GND_1"},
                    {"fromPin": "vcc", "toPin": "power_3v3_a"}
                ]
            }
        ]
    }
...
def test_json_to_demol_peripherals():
    ...
    json_data = {
        ...
        "peripherals": [
            {
                "name": "BME680",
                "instanceName": "EnvSensor",
                "attributes": {
                    "address": {"default": "0x76"}
                }
            },
            {
                "name": "LedGeneric",
    ...
    assert 'USE BME680 [EnvSensor] WITH address="0x76", LedGeneric [StatusLed];' in demol_str or \
           'USE BME680 [EnvSensor] WITH address="0x76"' in demol_str and 'LedGeneric [StatusLed]' in demol_str
...
def test_json_to_demol_connections_horizontal_logic():
    ...
    json_data = {
        ...
        "broker": {"type": "MQTT", "name": "B", "host": "h", "port": 1883},
        "peripherals": [
            {"name": "BME680", "instanceName": "MyBME"}
        ],
        "connections": [
            {
                "fromName": "MyBME",
...
def test_json_to_demol_gpio_connection():
    ...
    json_data = {
        ...
        "broker": {"type": "MQTT", "name": "B", "host": "h", "port": 1883},
        "peripherals": [
            {"name": "LedGeneric", "instanceName": "MyLed"}
        ],
        "connections": [
            {
                "fromName": "MyLed",
                ...
                "props": {"mode": "output"},
                "mappings": [
                    {"fromPin": "vin", "toPin": "GPIO18", "section": "data"}
                ]
            }
        ]
    }
...
def test_json_to_demol_uart_connection():
    ...
    json_data = {
        ...
        "broker": {"type": "MQTT", "name": "B", "host": "h", "port": 1883},
        "peripherals": [
            {"name": "TFMini", "instanceName": "Lidar"}
        ],
        "connections": [
            {
                "fromName": "Lidar",
